    ...
    <div className="bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-20 items-center">
            ...
            >
              ...
              <div className="absolute -bottom-6 -left-6 md:-bottom-10 md:-left-10 bg-white p-6 md:p-8 rounded-3xl shadow-xl hidden sm:block max-w-xs border border-slate-100">
                <p className="text-slate-900 font-bold mb-2 uppercase text-[10px] tracking-widest text-primary">Our Philosophy</p>
                <p className="text-slate-600 text-xs md:text-sm italic leading-relaxed">"Architecture should speak of its time and place, but yearn for timelessness."</p>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-16 md:py-24 bg-slate-50">
        <div className="container mx-auto px-6 text-center">
          <div className="max-w-3xl mx-auto mb-12 md:mb-20">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4 md:mb-6">Our Core Values</h2>
            <p className="text-base md:text-lg text-slate-600 leading-relaxed">The principles that guide our decisions, our designs, and our relationships with every client.</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            {coreValues.map((value, i) => (
              ...
              >
                <div className={`w-14 h-14 md:w-16 md:h-16 ${value.bg} ${value.color} rounded-2xl flex items-center justify-center text-xl md:text-2xl mb-6 mx-auto group-hover:scale-110 transition-transform`}>
        ...
        <div className="container mx-auto px-6">
          <div className="bg-slate-900 rounded-[2.5rem] md:rounded-[3rem] p-8 md:p-16 lg:p-20 text-white relative overflow-hidden">
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 items-center">
              <div>
                <h2 className="text-2xl md:text-3xl font-bold mb-6 md:mb-8">Our Commitment to Excellence</h2>
            ...
            {/* Background pattern */}
            <div className="absolute top-0 right-0 w-64 h-64 md:w-96 md:h-96 bg-primary/10 rounded-full blur-[100px] md:blur-[120px] -mr-32 -mt-32 md:-mr-48 md:-mt-48"></div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-primary relative overflow-hidden">
        <div className="container mx-auto px-6 text-center relative z-10">
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 md:mb-8">Ready to Start Your Project?</h2>
